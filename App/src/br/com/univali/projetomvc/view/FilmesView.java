package br.com.univali.projetomvc.view;

import java.util.ArrayList;
import java.util.List;

import br.com.univali.projetomvc.model.dtos.*;
import br.com.univali.projetomvc.controllers.*;
import br.com.univali.projetomvc.utils.*;
...
public class FilmesView {
	...
	public boolean cadastrarFilme() {
		...
		double nota = Leitura.LeDouble("  Informa a sua nota para o filme: ");
	...
	public void procurarFilmePorNota() {
		...
		double nota = Leitura.LeDouble("Qual o valor da nota que o filme deve ser maior ou igual? ");
